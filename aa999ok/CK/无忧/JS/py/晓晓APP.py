...
class Spider(Spider):
    ...
    def init(self, extend=""):
        # 替换为晓晓APP的配置
        self.host = 'https://ys.ewo.asia'
        self.key = "Z0qTnwyLAJCtuIkI"
        self.iv = "Z0qTnwyLAJCtuIkI"
    ...
    def detailContent(self, ids):
        ...
        # 对播放线路进行排序：4K/4k优先，然后2K/2k
        play_list = data["vod_play_list"]
        ...
        for item in play_list:
            name = item["player_info"]["show"].lower()
            if '4k' in name:
                list_4k.append(item)
            elif '2k' in name:
                list_2k.append(item)
        ...
        # 合并分组
        sorted_play_list = list_4k + list_2k + list_other
        
        for itt in sorted_play_list:
            a = []
