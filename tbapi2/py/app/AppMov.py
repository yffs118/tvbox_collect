    ...
    def playerContent(self, flag, id, vipflags):
        ...
        if re.match(r'https?:\/\/.*\.(m3u8|mp4|flv|mkv)', id):
            ...
            try:
                ...
                if re.search(r'(?:www\.iqiyi|v\.qq|v\.youku|www\.mgtv|www\.bilibili)\.com', id): url,jx = id,1
        return { 'jx': jx, 'parse': parse, 'url': url, 'header': {'User-Agent': 'com.gjkj.zxysdq/1.1.0 (Linux;Android 12) ExoPlayerLib/2.12.3'}}
