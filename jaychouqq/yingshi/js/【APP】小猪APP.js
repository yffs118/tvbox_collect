...
const SOURCE_CONFIG = {
  // 站点配置
  name: "【APP】小猪APP",
  site: "https://tiantangyoulu.oss-cn-beijing.aliyuncs.com/aoteman.txt",
  api: "2",
  dataKey: "lp3d4t53y9t5db8y",
  dataIv: "lp3d4t53y9t5db8y",
  init: "initV122",
  search: "searchList9",
  version: "",
  ua: "okhttp/3.10.0",
  
  // headers配置 - 小猪不需要特殊headers
  headers: {
  ...
  // 分类管理配置
  categories: {
    blockedNames: ["全部"],   // 屏蔽分类名称
    renameMap: {},            // 重命名
    forceOrder: ["电影","电视剧","综艺","动漫","短剧","直播"]
  },
...
const LineManager = {
  lines: {
    'N蓝光': { displayName: '🌷N蓝光线路', order: 101, mode: 'direct', enabled: true },
    'A蓝光': { displayName: '🌷A蓝光线路', order: 102, mode: 'direct', enabled: true },
    'R蓝光': { displayName: '🌷R蓝光线路', order: 103, mode: 'direct', enabled: true },
    'J蓝光': { displayName: '🌷J蓝光线路', order: 104, mode: 'direct', enabled: true },
    'S蓝光': { displayName: '🌷S蓝光线路', order: 105, mode: 'direct', enabled: true },
    '暴风': { displayName: '❤️暴风资源', order: 301, mode: 'direct', enabled: true },
    '天堂': { displayName: '❤️天堂资源', order: 302, mode: 'direct', enabled: true },
    '猫眼': { displayName: '❤️猫眼资源', order: 303, mode: 'direct', enabled: true  },
    '豆瓣': { displayName: '❤️豆瓣资源', order: 304, mode: 'direct', enabled: true },
    '天涯': { displayName: '❤️天涯资源', order: 305, mode: 'direct', enabled: true }
  },
