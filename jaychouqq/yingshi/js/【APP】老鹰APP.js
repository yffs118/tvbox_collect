...
const SOURCE_CONFIG = {
  // 站点配置
  name: "【APP】老鹰APP",
  site: "https://maotouyinghubei.oss-cn-wuhan-lr.aliyuncs.com/maotouyinghb.txt",  // 从OSS获取host
  // url: "",  // 老鹰不提供直接url，通过site获取
  api: "2",
...
const LineManager = {
  lines: {
    'VIP': { displayName: '🦅VIP线路', order: 100, mode: 'direct', enabled: true },
    '蓝光': { displayName: '🦅蓝光线路', order: 101, mode: 'direct', enabled: true }
  },
