...
const LineManager = {
  lines: {
    '腾播线路': { displayName: '⭐️腾讯视频', order: 201, mode: 'direct',  enabled: true },
    '芒播线路': { displayName: '⭐️芒果TV', order: 202, mode: 'direct', enabled: true },
    '奇播线路': { displayName: '⭐️爱奇艺', order: 203, mode: 'direct', enabled: true },
    '酷播线路': { displayName: '⭐️优酷视频', order: 204, mode: 'direct', enabled: true },
    '4K': { displayName: '🌹4K高清', order: 100, mode: 'direct', enabled: true },
    '蓝光一线': { displayName: '🌷NBY线路', order: 101, mode: 'direct', enabled: true },
    '蓝光二线': { displayName: '🌷YYNB线路', order: 102, mode: 'direct', enabled: true },
    '蓝光三线': { displayName: '🌷ACE线路', order: 103, mode: 'direct', enabled: true },
    '高清①': { displayName: '❤️优质资源', order: 301, mode: 'direct', enabled: true },
    '高清②': { displayName: '❤️暴风资源', order: 302, mode: 'direct', enabled: true  },
    '高清③': { displayName: '❤️非凡资源', order: 303, mode: 'direct', enabled: true }
  },
