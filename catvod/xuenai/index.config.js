...
var index_config_base_default = {
  ...
  danmu: {
    urls: [
           ...
           { address: "https://logo.saodu.work:8888/87654321", name: "默认2" }
          ],
    autoPush: true
  },
  //排序
  order: ["baidu", "uc", "tyi", "quark", "yd", "pan123", "ali", "y115"],
  //网盘
  uc: {
    enable: true,
    prefix: "UC",
  ...
  tgsou: {
    ...
    count: 1,
    pic: false,
    channelUsername: "wydwpzy,zyywpzy,ydwpzy,yunpanuc,ucquark"
  },
  tgchannel: {
    ...
    pic: true,
    channelUsername: "wydwpzy,zyywpzy,ydwpzy,yunpanuc,ucquark",
    homeChannelUsername: "wydwpzy,zyywpzy,ydwpzy,yunpanuc,ucquark"
  },
  //alist
  alist: [
    {
